...
class SysCatalog : private CommonFileOperations {
 public:
  ...
  void storeDataMgrStatistics(
    bool isPmem, size_t& peakWorkVmSize,
  ...
  int loadDataMgrStatistics(
    ...
    std::map<unsigned long, std::map<std::vector<int>, size_t>>& queryColumnFetchStats,
    std::map<unsigned long, std::map<std::vector<int>, size_t>>& queryColumnChunkFetchStats,
    std::map<unsigned long, std::map<std::vector<int>, size_t>>& queryColumnDataFetchStats,
    std::map<std::vector<int>, size_t>& columnFetchStats,
